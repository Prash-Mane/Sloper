...
{
	public class CarouselIndicatorsViewModel : Grid
    {
        ...
        public CarouselIndicatorsViewModel()
        {
        ...
        public static readonly BindableProperty PositionProperty = BindableProperty.Create(nameof(Position), typeof(int), typeof(CarouselIndicatorsViewModel), 0, BindingMode.TwoWay, propertyChanging: PositionChanging);
        public static readonly BindableProperty ItemsSourceProperty = BindableProperty.Create(nameof(ItemsSource), typeof(IEnumerable), typeof(CarouselIndicatorsViewModel), Enumerable.Empty<object>(), BindingMode.OneWay, propertyChanged: ItemsChanged);
        public static readonly BindableProperty SelectedIndicatorProperty = BindableProperty.Create(nameof(SelectedIndicator), typeof(string), typeof(CarouselIndicatorsViewModel), "", BindingMode.OneWay);
        public static readonly BindableProperty UnselectedIndicatorProperty = BindableProperty.Create(nameof(UnselectedIndicator), typeof(string), typeof(CarouselIndicatorsViewModel), "", BindingMode.OneWay);
        public static readonly BindableProperty IndicatorWidthProperty = BindableProperty.Create(nameof(IndicatorWidth), typeof(double), typeof(CarouselIndicatorsViewModel), 0.0, BindingMode.OneWay);
        public static readonly BindableProperty IndicatorHeightProperty = BindableProperty.Create(nameof(IndicatorHeight), typeof(double), typeof(CarouselIndicatorsViewModel), 0.0, BindingMode.OneWay);
        ...
        {
            var carouselIndicators = bindable as CarouselIndicatorsViewModel;
        ...
        private static void ItemsChanged(object bindable, object oldValue, object newValue)
        {
            ...
            if (newValue is INotifyCollectionChanged) {
                var obsCol = newValue as INotifyCollectionChanged;
                obsCol.CollectionChanged -= carouselIndicators.OnCollectionChanged; //to avoid stacking subscription to event
                obsCol.CollectionChanged += carouselIndicators.OnCollectionChanged;
            }
