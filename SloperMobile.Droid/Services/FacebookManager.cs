...
namespace SloperMobile.Droid.Services
{
    public class FacebookManager : Java.Lang.Object, IFacebookManager, IFacebookCallback, GraphRequest.IGraphJSONObjectCallback
    {
        ...
        {
            var n = result as Xamarin.Facebook.Login.LoginResult;
            if (n != null)
            {
        ...
        public void OnCompleted(JSONObject p0, GraphResponse p1)
        {
            ...
            _onLoginComplete?.Invoke(new FacebookUser(id, AccessToken.CurrentAccessToken.Token, first_name, last_name, email, pictureUrl), string.Empty);
        }
        #endregion
    }
}